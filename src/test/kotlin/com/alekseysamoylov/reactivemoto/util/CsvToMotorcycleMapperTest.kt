...
internal class CsvToMotorcycleMapperTest {
  ...
  fun shouldParseMotoFromCsv() {
    // Given
    val expectedAprilia = Motorcycle(1, maker = Maker(1, name = "Aprilia"), name = "RSV 1000R Factory", year = 2009)
    val expectedBmw = Motorcycle(2, maker = Maker(2, name = "BMW"), name = "S 1000 RR Sport", year = 2017)
    val expectedDucati = Motorcycle(3, maker = Maker(3, name = "Ducati"), name = "Monster 1200 S ABS", year = 2017)
    val expectedYamaha = Motorcycle(4, maker = Maker(4, name = "Yamaha"), name = "YZF-R1", year = 2017)
